            ...
            if route_1[i] == route_2[i]:
                if num_try == 2:
                    ...
                    if starter == 1:
                        ...
                        return reattempt_adjustment(route_1, route_2, num_try, 'Resources/winning_routesm.txt'), route_1, route_2
        return False, route_1, route_2
    except IndexError:
        return False, route_1, route_2
    ...
    for winning_route in winning_routes:
        ...
        for i in range(len(route_1)):
            if new_route_1[i] == route_2[i]:
                if num_try == 2:
                    new_route_2.insert(i, route_2[i - 1])
                else:
                    new_route_1.insert(i, new_route_1[i - 1])
        if new_route_1 != route_1 and new_route_2 != route_2:
            return True
    return False
